...
class ProfileView : UIView {
    ...
    func buildStatCards() {
        let totalCard = makeStatCard(valueLabel: totalValueLabel, label: "Total",
                                     valueColor: .systemGray, labelColor: .systemGray3,
                                     bgColor: .appSurface)
        let halalCard = makeStatCard(valueLabel: halalValueLabel, label: "Halal",
                                     valueColor: .appHalalText, labelColor: .appHalalStatLabel,
                                     bgColor: .appHalalStatBg)
        let haramCard = makeStatCard(valueLabel: haramValueLabel, label: "Not Halal",
    ...
    func setupProgressCard() {
        ...
        progressTitleLabel.text = "Halal Rate"
    ...
    func enterCardAtt() {
        let nameRow     = makeAccountRow(title: "Edit Name",      icon: "✏️", iconBackgroundColor: .appGreenSubtle, button: editNameButton)
        let passwordRow = makeAccountRow(title: "Change Password", icon: "🔒", iconBackgroundColor: .appBlueSubtle,  button: editPasswordButton)
        createSupportCard(below: progressCard, sectionText: "Account",
                          card: accountCard, row1: nameRow, row2: passwordRow)

        let ratingRow   = makeAccountRow(title: "Rate App",             icon: "⭐️", iconBackgroundColor: .appBlueSubtle, button: ratingButton)
        let feedbackRow = makeAccountRow(title: "Contact / Help",      icon: "❓", iconBackgroundColor: .appRedSubtle,  button: feedbackButton)
        createSupportCard(below: accountCard, sectionText: "Support",
