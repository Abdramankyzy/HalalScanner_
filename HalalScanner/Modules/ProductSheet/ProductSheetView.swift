...
class ProductSheetView : UIView {
    ...
    func setupUI() {
        ...
        row1.addArrangedSubview(makeInfoCell(title: "Accuracy", valueLabel: confidenceValueLabel))
        row1.addArrangedSubview(makeInfoCell(title: "Status", valueLabel: statusValueLabel))

        row2.addArrangedSubview(makeInfoCell(title: "Calories", valueLabel: caloriesValueLabel))
        row2.addArrangedSubview(makeInfoCell(title: "Category", valueLabel: categoryValueLabel))
        ...
        warnTitle.text = "Doubtful ingredients:"
